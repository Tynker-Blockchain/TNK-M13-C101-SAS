...
def home():
    ...
    if isSignedIn:
        ...
        if account:
            ...
            # Create example data lables and values for the pie chart
            ...
            # Create a dictionary for the pie chart data
            pie_data = {
                "labels": labels,
                "values": values,
                "type": "pie"
